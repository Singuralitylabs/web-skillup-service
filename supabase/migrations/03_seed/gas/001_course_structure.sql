...
BEGIN
  ...
  -- Phase 1: 基礎文法
  SELECT id INTO v_phase1_id FROM learning_phases WHERE theme_id = v_theme_id AND name = 'Phase 1 - 基礎文法';
  ...
  -- Phase 2: Googleドライブ
  SELECT id INTO v_phase2_id FROM learning_phases WHERE theme_id = v_theme_id AND name = 'Phase 2 - Googleドライブ';
  ...
  -- Phase 3: スプレッドシート活用
  SELECT id INTO v_phase3_id FROM learning_phases WHERE theme_id = v_theme_id AND name = 'Phase 3 - スプレッドシート活用';
  ...
  -- Phase 4: Gmailの送信
  SELECT id INTO v_phase4_id FROM learning_phases WHERE theme_id = v_theme_id AND name = 'Phase 4 - Gmailの送信';
  IF v_phase4_id IS NULL THEN
    INSERT INTO learning_phases (theme_id, name, description, display_order, is_published)
    VALUES (v_theme_id, 'Phase 4 - Gmailの送信', 'GASによるGmail送信とスプレッドシートを活用したメール配信システムを学びます', 4, true)
    RETURNING id INTO v_phase4_id;
  END IF;

  -- Phase 5: Googleフォーム
  SELECT id INTO v_phase5_id FROM learning_phases WHERE theme_id = v_theme_id AND name = 'Phase 5 - Googleフォーム';
  IF v_phase5_id IS NULL THEN
    INSERT INTO learning_phases (theme_id, name, description, display_order, is_published)
    VALUES (v_theme_id, 'Phase 5 - Googleフォーム', 'Googleフォームの作成・トリガー・DB操作を学びます', 5, true)
    RETURNING id INTO v_phase5_id;
  END IF;

  -- Phase 6: Googleカレンダー
  SELECT id INTO v_phase6_id FROM learning_phases WHERE theme_id = v_theme_id AND name = 'Phase 6 - Googleカレンダー';
  IF v_phase6_id IS NULL THEN
    INSERT INTO learning_phases (theme_id, name, description, display_order, is_published)
    VALUES (v_theme_id, 'Phase 6 - Googleカレンダー', 'Googleカレンダーのイベント操作とエラーハンドリングを学びます', 6, true)
    RETURNING id INTO v_phase6_id;
  END IF;

  -- Phase 7: GASの便利な機能
  SELECT id INTO v_phase7_id FROM learning_phases WHERE theme_id = v_theme_id AND name = 'Phase 7 - GASの便利な機能';
  IF v_phase7_id IS NULL THEN
    INSERT INTO learning_phases (theme_id, name, description, display_order, is_published)
    VALUES (v_theme_id, 'Phase 7 - GASの便利な機能', 'プロパティストア・ダイアログ・ログ出力などGASの便利な機能を学びます', 7, true)
    RETURNING id INTO v_phase7_id;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'video') THEN
    ...
    VALUES (v_week_id, '基礎文法の学習1（動画）', 'video', 'https://www.youtube.com/watch?v=VkvRU334DYI', 1, true);
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'video') THEN
    INSERT INTO learning_contents (week_id, title, content_type, video_url, display_order, is_published)
    VALUES (v_week_id, '基礎文法の学習2（動画）', 'video', 'https://www.youtube.com/watch?v=TCzYJ3Fxbl0', 1, true);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'slide') THEN
    INSERT INTO learning_contents (week_id, title, content_type, pdf_url, display_order, is_published)
  ...
  IF v_week_id IS NULL THEN
    INSERT INTO learning_weeks (phase_id, name, description, display_order, is_published)
    VALUES (v_phase2_id, 'Googleドライブの操作',
  ...
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'video') THEN
    INSERT INTO learning_contents (week_id, title, content_type, video_url, display_order, is_published)
    VALUES (v_week_id, 'Googleドライブの操作（動画）', 'video', 'https://www.youtube.com/watch?v=yKeofE0xtK4', 1, true);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'slide') THEN
    INSERT INTO learning_contents (week_id, title, content_type, pdf_url, display_order, is_published)
  ...
  IF v_week_id IS NULL THEN
    INSERT INTO learning_weeks (phase_id, name, description, display_order, is_published)
    VALUES (v_phase3_id, 'スプレッドシート操作1',
  ...
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'video') THEN
    INSERT INTO learning_contents (week_id, title, content_type, video_url, display_order, is_published)
    VALUES (v_week_id, 'スプレッドシート操作1（動画）', 'video', 'https://www.youtube.com/watch?v=wyx0KM46TwU', 1, true);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'slide') THEN
    INSERT INTO learning_contents (week_id, title, content_type, pdf_url, display_order, is_published)
  ...
  IF v_week_id IS NULL THEN
    INSERT INTO learning_weeks (phase_id, name, description, display_order, is_published)
    VALUES (v_phase3_id, 'スプレッドシート操作2',
      E'- 複数セルの取得と入力（2次元配列）\n- シートの操作\n- 行・列の追加\n- 行・列の削除\n- カスタム関数',
      2, true)
    RETURNING id INTO v_week_id;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'video') THEN
    INSERT INTO learning_contents (week_id, title, content_type, video_url, display_order, is_published)
    VALUES (v_week_id, 'スプレッドシート操作2（動画）', 'video', 'https://www.youtube.com/watch?v=o-kX-lelHXY', 1, true);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'slide') THEN
    INSERT INTO learning_contents (week_id, title, content_type, pdf_url, display_order, is_published)
  ...
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'video') THEN
    INSERT INTO learning_contents (week_id, title, content_type, video_url, display_order, is_published)
    VALUES (v_week_id, 'データベース活用（動画）', 'video', 'https://www.youtube.com/watch?v=7bkNZbKlszY', 1, true);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'slide') THEN
    INSERT INTO learning_contents (week_id, title, content_type, pdf_url, display_order, is_published)
  ...
  -- Week 4: Gmailの送信
  SELECT id INTO v_week_id FROM learning_weeks WHERE phase_id = v_phase4_id AND name = 'Gmailの送信';
  IF v_week_id IS NULL THEN
    INSERT INTO learning_weeks (phase_id, name, description, display_order, is_published)
    VALUES (v_phase4_id, 'Gmailの送信',
  ...
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'video') THEN
    INSERT INTO learning_contents (week_id, title, content_type, video_url, display_order, is_published)
    VALUES (v_week_id, 'Gmailの送信（動画）', 'video', 'https://www.youtube.com/watch?v=EjjHHt-oVKc', 1, true);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'slide') THEN
    INSERT INTO learning_contents (week_id, title, content_type, pdf_url, display_order, is_published)
  ...
  -- Week 5-1: Googleフォーム
  SELECT id INTO v_week_id FROM learning_weeks WHERE phase_id = v_phase5_id AND name = 'Googleフォーム';
  IF v_week_id IS NULL THEN
    INSERT INTO learning_weeks (phase_id, name, description, display_order, is_published)
    VALUES (v_phase5_id, 'Googleフォーム',
      E'- Googleフォームとは\n- GoogleフォームのGAS活用事例\n- Googleフォームへのアクセス\n- フォームタイトル・説明文の取得\n- Googleフォームの作成\n- フォーム設問の作成・設定・削除',
      1, true)
    RETURNING id INTO v_week_id;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'video') THEN
    INSERT INTO learning_contents (week_id, title, content_type, video_url, display_order, is_published)
    VALUES (v_week_id, 'Googleフォーム（動画）', 'video', 'https://www.youtube.com/watch?v=7EmiOhVmkFs', 1, true);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'slide') THEN
    INSERT INTO learning_contents (week_id, title, content_type, pdf_url, display_order, is_published)
  ...
  SELECT id INTO v_week_id FROM learning_weeks WHERE phase_id = v_phase5_id AND name = 'Googleフォームの活用';
  IF v_week_id IS NULL THEN
    INSERT INTO learning_weeks (phase_id, name, description, display_order, is_published)
    VALUES (v_phase5_id, 'Googleフォームの活用',
      E'- トリガー機能\n- フォーム回答の取得\n- GoogleフォームによるDB操作',
      2, true)
    RETURNING id INTO v_week_id;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'video') THEN
    INSERT INTO learning_contents (week_id, title, content_type, video_url, display_order, is_published)
    VALUES (v_week_id, 'Googleフォームの活用（動画）', 'video', 'https://www.youtube.com/watch?v=ioq82NFX0Z4', 1, true);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'slide') THEN
    INSERT INTO learning_contents (week_id, title, content_type, pdf_url, display_order, is_published)
  ...
  SELECT id INTO v_week_id FROM learning_weeks WHERE phase_id = v_phase6_id AND name = 'Googleカレンダー操作';
  IF v_week_id IS NULL THEN
    INSERT INTO learning_weeks (phase_id, name, description, display_order, is_published)
    VALUES (v_phase6_id, 'Googleカレンダー操作',
  ...
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'video') THEN
    INSERT INTO learning_contents (week_id, title, content_type, video_url, display_order, is_published)
    VALUES (v_week_id, 'Googleカレンダー操作（動画）', 'video', 'https://www.youtube.com/watch?v=FOJMKV7l7n4', 1, true);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'slide') THEN
    INSERT INTO learning_contents (week_id, title, content_type, pdf_url, display_order, is_published)
  ...
  SELECT id INTO v_week_id FROM learning_weeks WHERE phase_id = v_phase6_id AND name = 'フォームによるカレンダー操作';
  IF v_week_id IS NULL THEN
    INSERT INTO learning_weeks (phase_id, name, description, display_order, is_published)
    VALUES (v_phase6_id, 'フォームによるカレンダー操作',
  ...
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'video') THEN
    INSERT INTO learning_contents (week_id, title, content_type, video_url, display_order, is_published)
    VALUES (v_week_id, 'フォームによるカレンダー操作（動画）', 'video', 'https://www.youtube.com/watch?v=2Fusjw7Ax0I', 1, true);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'slide') THEN
    INSERT INTO learning_contents (week_id, title, content_type, pdf_url, display_order, is_published)
  ...
  -- Week 7: GASの便利な機能
  SELECT id INTO v_week_id FROM learning_weeks WHERE phase_id = v_phase7_id AND name = 'GASの便利な機能';
  IF v_week_id IS NULL THEN
    INSERT INTO learning_weeks (phase_id, name, description, display_order, is_published)
    VALUES (v_phase7_id, 'GASの便利な機能',
      E'- プロパティストアへのデータ保存\n- ダイアログの出力\n- スプレッドシートからのGAS実行\n- ログ出力の分類\n- 関数のコメントの設定',
      1, true)
    RETURNING id INTO v_week_id;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'video') THEN
    INSERT INTO learning_contents (week_id, title, content_type, video_url, display_order, is_published)
    VALUES (v_week_id, 'GASの便利な機能（動画）', 'video', 'https://www.youtube.com/watch?v=vo87BAKkC8E', 1, true);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM learning_contents WHERE week_id = v_week_id AND content_type = 'slide') THEN
    INSERT INTO learning_contents (week_id, title, content_type, pdf_url, display_order, is_published)
